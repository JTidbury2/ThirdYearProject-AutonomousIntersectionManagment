...
# # # # Single entrance only goes straight
...
# # Draw flow
# plt.plot(inflow_light, outflow_light, '-o', label='Signal Control')
# plt.plot(inflow_dres, outflow_dres, '-o', label='Dresner scheme')
# plt.plot(inflow_xu, outflow_xu, '-o', label='Xu plan')
...
# plt.xlabel('Simulation input traffic (pcu/hour)', fontproperties=font_ch)
# plt.ylabel('Actual outflow traffic (pcu/hour)', fontproperties=font_ch)
# plt.title('Accessibility', fontproperties=font_ch)
# plt.legend(prop=font_ch)
# plt.show()

# draw delay
plt.plot(inflow_light, avg_delay_light, '-o', label='Signal Control')
plt.plot(inflow_dres, avg_delay_dres, '-o', label='Dresner scheme')
plt.plot(inflow_xu, avg_delay_xu, '-o', label='Xu plan')
...
plt.xlabel('Simulation input traffic (pcu/hour)', fontproperties=font_ch)
plt.ylabel('Average delay (s)', fontproperties=font_ch)
plt.title('Average delay', fontproperties=font_ch)
plt.legend(prop=font_ch)
plt.show()
